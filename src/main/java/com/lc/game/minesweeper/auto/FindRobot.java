...
public class FindRobot {
    ...
    public FindRobot(String keyImagePath, String screenshot, int x, int y) {
        screenShotImage = (screenshot == null || "".equals(screenshot)) ? this.getFullScreenShot() : this.getBfImageFromPath(screenshot);
    ...
    public static String writeImageFile(BufferedImage bi) {
        String path = "";
        try {
            path = "C:\\Users\\dell\\Desktop\\扫雷素材\\截图" + System.currentTimeMillis() + ".png";
    ...
    public BufferedImage getBfImageFromPath(String keyImagePath) {
        BufferedImage bfImage = null;
        try {
            bfImage = ImageIO.read(this.getClass().getClassLoader().getResource(keyImagePath));
        } catch (IOException e) {
            e.printStackTrace();
        }
        return bfImage;
    ...
    public static void main(String[] args) {
        ...
        new FindRobot("img/格子.png","img/截图.png",0,0);
        new FindRobot("img/选中格子.png","img/截图.png",0,0);
...
//        demo.map.values().stream().forEach(v -> {
//            String v1 = (String) v;
//            Arrays.stream(xs).forEach(x -> {
//                if (!count.containsKey(x)) {
//                    count.put(x, 0);
//                }
//                if (v1.contains(String.valueOf(x))) {
//                    count.put(x, count.get(x) + 1);
//                }
//            });
//            Arrays.stream(ys).forEach(y -> {
//                if (!count.containsKey(y)) {
//                    count.put(y, 0);
//                }
//                if (v1.contains(String.valueOf(y))) {
...
//            }
//            touchPic("C:\\Users\\dell\\Desktop\\扫雷素材\\格子.png");
//        }
    }
